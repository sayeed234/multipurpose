                    ...
                    <div class="row">
                            <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                     ...
                                     <input type="text"value="TV<?php  echo'' .$date. $i; ?>" class="form-control " id="t_voucher" name="t_voucher" readonly >
                            ...
                            <div class="col-sm-6">
                                    <div class="form-group">
                                                     <label for="name">Debit Head:</span></label>
                                                    
                                                     <select name="t_debit_head" id="t_debit_head" class="form-control" required>
                        ...
                        <div class="col-sm-6">
                                <div class="form-group">
                                                 <label for="name">Credit Head:</span></label>
            ...
            <div class="modal-body">
                    <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                 <label for="code">Debit Head Balance</label>
                                 <input type="text" class="form-control t_debit_belence" id="t_debit_belence" name="t_debit_belence" >
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                             <label for="code">Credit Head Balance</label>
                             <input type="text" class="form-control t_credit_belence" id="t_credit_belence" name="t_credit_belence" >
            ...
            <div class="ibox-body">
                    <table class="table table-striped table-bordered table-hover" id="example-table" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            ...
                            <td>{{$item->t_debit_head}}</td>
                            <td>{{$item->t_credit_head}}</td>
                            <td>{{$item->t_des}}</td>
                            <td>{{$item->t_amount}}</td>
