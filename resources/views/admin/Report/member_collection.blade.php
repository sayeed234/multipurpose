...
<div class="page-content fade-in-up">  
 <div class="ibox"style="margin-top: 5px;">            
            <div class="ibox-head">
                    <div class="card-body">                                           
                    <form action="{{url('/member_collection_report')}}" method="get"> 
                        @csrf
                                <div class="row">
                                <div class="col-md-3 ">
                                        <div class="row">
            ...
            @if(session()->has('member')==0)

                 @else
          <a href="{{ url('member_collection_report/invoice/'.Session::get('member')) }}"  class="btn btn-info" title="Report" style="margin-left:500px;"> Print This Statement</a>
