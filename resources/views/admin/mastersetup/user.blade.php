                    ...
                    <div class="row">
                            <div class="col-sm-6">
                                 <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" required id="name" name="first_name" placeholder="First Name">
                          ...
                          <div class="row">
                              <div class="col-sm-6">
                                 <div class="form-group">
                                  ...
                                  <input type="email" class="form-control" id="name"required name="email" placeholder="Email Address">
                          ...
                          <div class="row">
                              <div class="col-sm-6">
                                 <div class="form-group">
                                  ...
                                  <input type="password" required class="form-control" id="password" name="user_password" placeholder="New Password" minlength="8">
                              ...
                              <div class="col-sm-6">
                                 <div class="form-group">
                                  ...
                                  <input type="password"required class="form-control" id="conpassword" name="conform_password" placeholder="Conform Password" minlength="8">
                            ...
                            <div class="row">
                                  ...
                                  <div class="row">
                                      <div class="col-sm-6">
                                         <div class="form-group">
                                          <label for="name">Email:<span class="star"></span></label>
                                          <input type="email" class="form-control email" id="name" name="email" placeholder="Email Address">
                                          <span class="text-danger">{{$errors->has('email')? $errors->first('email'):''}}</span>
                                        </div>
                                      </div>
                                      <div class="col-sm-6">
  ...
  <script>
        ...
        $('#password').keyup(function(){
              ...
              if(x<8){
                  ...
                  $('#passwordmess').text('Password Strong');  
              }
        });
  </script>
