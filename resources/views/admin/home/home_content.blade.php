                 ...
                 @if(Session::get('adminrole')==1)
                    <div class="col-lg-3 col-md-6">
                        <div class="ibox bg-success color-white widget-stat">
                            <div class="ibox-body">
                                <div class="m-b-5"><b>Total Collection Balance</b></div>
                                <h2 class="m-b-5 font-strong">
                                {{$total_collection->total}} Tk.</h2>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="ibox bg-info color-white widget-stat">
                            <div class="ibox-body">                           
                                <div class="m-b-5"><b> Total Kisti Balance</b></div>
                                    <h2 class="m-b-5 font-strong">{{$total_kisti->total}} Tk.</h2>
                                <div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="ibox bg-danger color-white widget-stat">
                            <div class="ibox-body">                               
                                <div class="m-b-5"><b>Total Loan Balance </b></div>
                                <h2 class="m-b-5 font-strong">
                                 {{$total_loan->total}} Tk.
                                </h2>
                                <div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="ibox bg-warning color-white widget-stat">
                            <div class="ibox-body">
                             <div class="m-b-5"><b>Total Fee </b></div>
                                <h2 class="m-b-5 font-strong">
                                {{$total_fee->total}} Tk.
                                 </h2>                             
                                <div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="ibox bg-success color-white widget-stat">
                            <div class="ibox-body">
                                <div class="m-b-5"><b>Today Collection Balance</b></div>
                                <h2 class="m-b-5 font-strong">
                                {{$today_collection->total}} Tk.</h2>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="ibox bg-info color-white widget-stat">
                            <div class="ibox-body">                           
                                <div class="m-b-5"><b> Today Total Kisti Balance</b></div>
                                    <h2 class="m-b-5 font-strong">{{$today_kisti->total}} Tk.</h2>
                                <div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="ibox bg-danger color-white widget-stat">
                            <div class="ibox-body">                               
                                <div class="m-b-5"><b>Today  Total Loan Balance </b></div>
                                <h2 class="m-b-5 font-strong">
                                 {{$today_loan->total}} Tk.
                                </h2>
                                <div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="ibox bg-warning color-white widget-stat">
                            <div class="ibox-body">
                             <div class="m-b-5"><b>Today Total Fee </b></div>
                                <h2 class="m-b-5 font-strong">
                                {{$today_fee->total}} Tk.
                                 </h2>                             
                                <div>
...
@endif
                ...
                <div class="col-lg-6">
                        <div class="ibox">
                            <div class="ibox-head btn-secondary">
                                <div class="ibox-title">Top Collection Member</div>
                            </div>
                            <div class="ibox-body">
                                <ul class="media-list media-list-divider m-0">
                                @foreach($topcollection as $topbuy )
                                    <li class="media">
                                        <div class="media-body">
                                            <div class="media-heading">
                                               <p>{{$topbuy->memberno }} . {{$topbuy->name }}
                                                <span class="font-16 float-right">{{$topbuy->total }} Tk.</span></p>
                                            </div>
                                        </div>
                                    </li>
                                   @endforeach
                ...
                <div class="col-lg-6">
                        <div class="ibox">
                            <div class="ibox-head btn-secondary">
                                <div class="ibox-title">Top Kisti Member</div>
                            </div>
                            <div class="ibox-body">
                                <ul class="media-list media-list-divider m-0">
                                @foreach($topkisti as $topsales)
                                    <li class="media">
                                     <div class="media-body">
                                        <div class="media-heading">
                                               <p>{{$topsales->memberno }} . {{$topsales->name }}
                                                <span class="font-16 float-right">{{$topsales->total }} Tk.</span></p>
                                            </div>                                            
